...
namespace Mathtone.Sdk.NeuralNetworks.Neurons {
	/// <summary>
	/// A <see cref="Mathtone.Sdk.NeuralNetworks.Neurons.ActivatorNeuron"/> with a sigmoid activation function.
	/// </summary>
	/// <seealso cref="Mathtone.Sdk.NeuralNetworks.Neurons.ActivatorNeuron" />
